...
Copy `QEMU-GUI.exe` anywhere you want and delete the rest
Quick Start
Install QEMU to `C:\Program Files\qemu` if you haven't already
Launch QEMU-GUI
Click New in the toolbar
Browse for an ISO — the app will auto-detect the OS and fill in recommended settings
Adjust the name and RAM if you want, optionally create or attach a disk image
Click OK to create the VM
Select it in the sidebar and click Start
...
HAX	Windows/macOS	Intel HAXM — must be installed separately. Intel CPUs only
